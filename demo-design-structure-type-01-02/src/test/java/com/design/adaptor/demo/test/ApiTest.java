...
import com.design.adaptor.demo.MQAdaptor;
...
import com.design.adaptor.demo.impl.POPOrderAdaptorServiceImpl;
...
public class ApiTest {
    ...
    public void test_MQAdaptor() throws ParseException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        ...
        RebateInfo rebateInfo01 = MQAdaptor.filter(createAccount.toString(), link01);
        ...
        RebateInfo rebateInfo02 = MQAdaptor.filter(orderMq.toString(), link02);
    ...
    public void test_itfAdapter() {
        OrderAdaptorService popOrderAdapterService = new POPOrderAdaptorServiceImpl();
        System.out.println("判断首单，接口适配(POP)：" + popOrderAdapterService.isFirst("10020001"));

        OrderAdaptorService insideOrderService = new InsideOrderService();
